...
When the user says `/autoresearch [topic]` or "research X", use the given topic verbatim and skip the section below.

### B. User-chosen (default when no topic is given)
